...
# operation compute the RMSE L2 loss function based on model error
loss = tf.sqrt(tf.reduce_mean(tf.square(error, name='L2-loss')))
...
'''
    Notice that convergence takes many many iteration to reach least-squares result
'''